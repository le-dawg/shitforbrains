...
while($row = mysqli_fetch_array($qry_result)){
	$display_string = "<input class='in_6' id='t9' type='text' name='telefon' value='$row[telefon]' tabindex='3'>";		
}
echo $display_string;
} else {
	$display_string2 = "<input class='in_6' id='t9' type='text' name='telefon' value='' tabindex='3'>";		
