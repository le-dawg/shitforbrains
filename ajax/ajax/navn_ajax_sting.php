...
while($row = mysqli_fetch_array($qry_result)){
	$display_string = "<input class='in_5' id='t2' type='text' name='navn' value='$row[navn]' tabindex='2'>";		
}
echo $display_string;
} else {
	$display_string2 = "<input class='in_5' id='t2' type='text' name='navn' value='' tabindex='2'>";		
