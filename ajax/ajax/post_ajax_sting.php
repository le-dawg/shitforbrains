...
while($row = mysqli_fetch_array($qry_result)){
	$display_string = "<input class='in_5' id='t6' type='text' name='post' value='$row[post]' tabindex='2'>";		
}
echo $display_string;
} else {
	$display_string2 = "<input class='in_5' id='t6' type='text' name='post' value='' tabindex='2'>";		
