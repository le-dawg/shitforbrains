...
while($row = mysqli_fetch_array($qry_result)){
	$display_string = "<input class='in_5' id='t4' type='text' name='adresse' value='$row[adresse]' tabindex='2'>";		
}
echo $display_string;
} else {
	$display_string2 = "<input class='in_5' id='t4' type='text' name='adresse' value='' tabindex='2'>";		
