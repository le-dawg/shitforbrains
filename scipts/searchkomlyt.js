...
$(document).ready(function() {  
	...
	setTimeout(function() {search2(); }, 2500);
                function search2() {
		var query_value = $('input#kap').val();
                var query_value = query_value + 'uF ';
                var query_value = query_value + $('input#volt').val();
	...
	$("input#volt").live("keyup", function(e) {
		// Set Timeout
        ...
        $("input#kap").live("keyup", function(e) {
		// Set Timeout
		clearTimeout($.data(this, 'timer'));
