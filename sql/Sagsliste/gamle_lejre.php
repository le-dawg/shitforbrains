<?php
	 ...
	 $ans = $rowsqllej['id'];
         ...
         $where[] = ("dato2 <= '$ru0' AND dato2 >= '$ru1' AND status_kode !='9' AND ans != '1' AND ans='50' AND ind_kode != '6'"); }
	 ...
	 $ans = $rowsqllej['id'];
         ...
         $where[] = ("dato2 <= '$ru1' AND dato2 >= '$ru2' AND status_kode !='9' AND ans != '1' AND ans='50' AND ind_kode != '6'"); }
         $where = implode(' OR ', $where);
	 ...
	 $ans = $rowsqllej['id'];
         ...
         $where[] = ("dato2 <= '$ru2' AND dato2 >= '$ru3' AND status_kode !='9' AND ans != '1' AND ans='50' AND ind_kode != '6'"); }
         $where = implode(' OR ', $where);
	 ...
	 $ans = $rowsqllej['id'];
         ...
         $where[] = ("dato2 <= '$ru3' AND dato2 >= '$ru4' AND status_kode !='9' AND ans != '1' AND ans='50' AND ind_kode != '6'"); }
         $where = implode(' OR ', $where);
	 ...
	 $ans = $rowsqllej['id'];
         ...
         $where[] = ("dato2 <= '$ru4' AND dato2 >= '$ru5' AND status_kode !='9' AND ans != '1' AND ans='50' AND ind_kode != '6'"); }
         $where = implode(' OR ', $where);
	 ...
	 $ans = $rowsqllej['id'];
         ...
         $where[] = ("dato2 <= '$ru5'  AND status_kode !='9' AND ans != '1' AND ans='50' AND ind_kode != '6'"); }
         $where = implode(' OR ', $where);
