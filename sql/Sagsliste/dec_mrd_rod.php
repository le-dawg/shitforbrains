...
<tr>
<td width="25%" height="20px"><font size="10px"><b> Rapport for Dec. <?php echo ' '.$year.' '; ?></font></b></td>
<td width="18.75%" height="20px"><font size="10px"><b> <?php echo ''.$ind0.''; ?></font></b></td>
<td width="18.75%" height="20px"><font size="10px"><b> <?php echo ''.$ind1.''; ?></font></b></td>
<td width="18.75%" height="20px"><font size="10px"><b> <?php echo ''.$ind4.''; ?></font></b></td>
<td width="18.75%" height="20px"><font size="10px"><b> <?php echo ''.$ind5.''; ?></font></b></td>
</tr>
</table>